...
#We can also use length when working with phone numbers to make sure that they are exactly 11 characters long.alter
...
SELECT first_name, LEFT(first_name, 3)  #How many characters from the left hand side do we want to select. 
FROM employee_demographics;
