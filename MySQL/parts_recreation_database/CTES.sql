...
SELECT gender, SUM(salary) sum_sal, MIN(salary) min_sal, MAX(salary) max_sal, COUNT(salary) count_sal, AVG(salary) savg_sal
...
FROM employee_salary   # or parks_and_recreation.employee_salary
WHERE salary >=50000
)
