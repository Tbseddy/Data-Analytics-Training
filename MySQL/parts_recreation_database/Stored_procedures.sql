...
# The way we have written is not actually best practice
...
# To alter an existing procedure right click on the procedure table under the Schema and select alter
-- we can also create a stored procedure by right clicking on Stored Procedures under Schema and creating one:
