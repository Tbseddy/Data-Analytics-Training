...
-- this is the primary way I've used temp tables especially if I'm just querying data and have some complex data 
-- I want to put into boxes or these temp tables to use later
